"""Read/Write files using PyFilesystem
"""
...
class PyFilesystemArchive(AbstractArchive):
    """Read/write local files."""

    name = "pyfilesystem"
    description = "Read and write files using PyFilesystem."
    ...
    def __init__(self, transport=None, url=None, mode='r',
        ...
        super(PyFilesystemArchive, self).__init__(self.name, self.description,
        ...
        logging.debug("PyFilesystemArchive __init__: {}".format(type(transport)))
        logging.debug("PyFilesystemArchive __init__ url: {}".format(url))
        ...
        for root, dirs, files in self.__transport.walk(self.__urldict.path):
            #logging.debug("PyFilesystemArchive scan root: {} {}".format(root, files))
            for filename in files:
                fname = os.path.join(self.__urldict.path, root, filename)
                #logging.debug("PyFilesystemArchive scan fname: {}".format(fname))
    ...
    def getnames(self):
        ...
        """
        #logging.debug('PyFilesystemArchive getnames: self.__filelist: {}'.format(
        #    self.__filelist))
        return(self.__fs.listdir())
    ...
    def to_localfile(self, filehandle):
        ...
        """
        #logging.debug('PyFilesystemArchive to_localfile: filename %s' %
        #        filehandle)
        return(filehandle)
    ...
    def __enter__(self):
        ...
        """
        logging.debug("PyFilesystemArchive __enter__: {} mode {}".format(type(self.__transport), self.__mode))
        return self
