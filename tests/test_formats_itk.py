...
class TestWritePluginITK_slice(unittest.TestCase):
    ...
    def test_write_3d_itk(self):
        ...
        self.assertEqual(si1.shape, (30, 192, 192))

        #log.debug("test_write_3d_itk: sliceLocations {}".format(
        #    hdr.sliceLocations))
        log.debug("test_write_3d_itk: tags {}".format(si1.tags))
        log.debug("test_write_3d_itk: spacing {}".format(si1.spacing))
        log.debug("test_write_3d_itk: imagePositions) {}".format(
            si1.imagePositions))
        log.debug("test_write_3d_itk: orientation {}".format(si1.orientation))
    ...
    def test_write_4d_itk(self):
        ...
        try:
            ...
            pass
        hdr.write_4d_numpy(si, 'tt4d', 'Image_%05d.mhd', self.opts)

        # Read back the DICOM data and verify that the header was modified
        hdr2,si2 = imagedata.readdata.read(
                #('tt4d/',),
                ('tt4d/Image_00000.mhd',
                 'tt4d/Image_00001.mhd',
                 'tt4d/Image_00002.mhd',
                 'tt4d/Image_00003.mhd',
                 'tt4d/Image_00004.mhd',
                 'tt4d/Image_00005.mhd',
                 'tt4d/Image_00006.mhd',
                 'tt4d/Image_00007.mhd',
                 'tt4d/Image_00008.mhd',
                 'tt4d/Image_00009.mhd'
                ),
                imagedata.formats.INPUT_ORDER_TIME,
                self.opts)
...
class TestWritePluginITK_tag(unittest.TestCase):
    ...
    def test_write_3d_itk(self):
        ...
        log.debug("test_write_3d_itk")
        hdr,si = imagedata.readdata.read(
                #('tests/mhd/volume/Image_00000.mhd',),
                ('tests/mhd/time/Image_00000.mhd',),
                0,
                self.opts)
        self.assertEqual(si.dtype, np.float64)
