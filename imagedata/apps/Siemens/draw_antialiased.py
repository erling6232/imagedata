...
def draw_circle_mask(canvas, center_x, center_y, outer_radius, colour, threshold, fill=True):
	...
	Optionally, fill the circle with the same colour.
	...
	"""
	"""
	def _draw_8point(canvas, center_x, center_y, x, y, colour):
		# Draw the 8 symmetries
		print("_draw_8point", center_y, center_x, y, x)
		print("_draw_8point", center_y + y,  center_x - x)
		print("_draw_8point", center_y + y,  center_x + x)
		print("_draw_8point", center_y - y,  center_x - x)
		print("_draw_8point", center_y - y,  center_x + x)
		print("_draw_8point", center_x + x,  center_y - y)
		print("_draw_8point", center_x + x,  center_y + y)
		print("_draw_8point", center_x - x,  center_y - y)
		print("_draw_8point", center_x - x,  center_y + y)
		
		canvas[center_y + y,  center_x - x] = colour
		canvas[center_y + y,  center_x + x] = colour
		canvas[center_y - y,  center_x - x] = colour
		canvas[center_y - y,  center_x + x] = colour
		canvas[center_x + x,  center_y - y] = colour
		canvas[center_x + x,  center_y + y] = colour
		canvas[center_x - x,  center_y - y] = colour
		canvas[center_x - x,  center_y + y] = colour
	"""
	...
	def _draw_8point(canvas, center_x, center_y, i, j, colour):
		...
		for i_, j_ in local_coord:
			# print("_draw_8point", center_y + j_,  center_x + i_)
			canvas[center_y + j_,  center_x + i_] = colour
...
def draw_ellipse_mask(canvas, center_x, center_y, outer_radius, colour, threshold, fill=True):
	...
	Optionally, fill the ellipse with the same colour.
	...
	Input:
	 ...
	 - fill: whether to fill the circle (boolean)
	"""
	def _draw_4point(canvas, center_x, center_y, x, y, colour):
		# Draw the 8 symmetries
		print("_draw_8point", center_y, center_x, y, x)
		print("_draw_8point", center_y + y,  center_x - x)
		print("_draw_8point", center_y + y,  center_x + x)
